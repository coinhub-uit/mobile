                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Test Section (for development/testing) - only show if auth is enabled
                      if (_pinEnabled || _fingerprintEnabled || _faceIdEnabled)
                        Container(
                          padding: const EdgeInsets.all(20),
                          decoration: BoxDecoration(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 12),
                              Text(
                                "Test the timeout functionality manually",
                                style: theme.textTheme.bodyMedium?.copyWith(
                              ...
                              ElevatedButton.icon(
                                onPressed: () async {
                                  debugPrint("Manual force lock triggered");
                                  await _timeoutService.forceLock();
                                  _showSnackBar(
                                    "App locked for testing (timeout: ${_autoLockTimeout}min)",
                                  );
                                },
                                style: ElevatedButton.styleFrom(
                                ...
                                label: const Text("Test Lock Screen"),
                              ),
                            ],
                          ),
                        ),
